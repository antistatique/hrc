...
module.exports = function() {
  ...
  gulp.task('styles:lint', function() {
    return gulp.src([config.assets + 'sass/**/*.s+(a|c)ss', '!' + config.assets + 'sass/+(bootstrap-variables|bootstrap|main|styleguide|styleguide-variables|main-variables|icon|_mixins).scss', '!' + config.assets + 'sass/organisms/_photoswipes.scss', '!' + config.assets + 'sass/molecules/_bootstrap-navbar.scss'])
        .pipe($.plumber({errorHandler: errorAlert}))
        .pipe($.stylelint({
          reporters: [
